(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
  1: [function (require, module, exports) {
    ...
    (function (global) {
      ...
      class OSMNearbyNotesDatabase extends dexie_1.default {
        constructor() {
    ...
    const dexie_db_1 = require('./dexie-db');
    ...
    if (typeof indexedDB === 'undefined') {
      ...
      (function () {
        const db = new dexie_db_1.OSMNearbyNotesDatabase();
        document.addEventListener('DOMContentLoaded', () => {
          const reactRootWrapperElement = document.querySelector('#AppWrapper');
          ...
          window.addEventListener('oauthButtonClicked', (event) => {
          ...
          window.addEventListener('getNearbyNotesClicked', (event) => {
                ...
                auth.xhr({
                  ...
                  if (error === null) {
                    ...
                    if (homeLocation !== null) {
                      ...
                      const receiveDataEvent = new CustomEvent('receiveCoordinate', {
                        detail: {
            ...
            const getNotes = (coordinate) => {
              return new Promise((resolve, reject) => {
                const edge = coordinate_calc_1.coordinateCalc.getCoordinateArea(coordinate, 10);
                auth.xhr({
                  method: 'GET',
            ...
            getUserHomeLocation().then(getNotes).then(setNotesList).then(() => findNotes(null)).catch((error) => {
          ...
          window.addEventListener('submitButtonClicked', (event) => {
            event.preventDefault();
            const noteId = +event.detail.noteId;
            const target = event.detail.target;
            const noteComponentElement = document.querySelector(`#note-${noteId}`);
            const postCommentAndMemoState = (target, noteId) => {
              return new Promise((resolve, reject) => {
                const osmXHRPost = (action, params) => {
                  auth.xhr(params, (error, xhr) => {
                    if (error === null) {
                ...
                const select = target.querySelector(`#note-${noteId}-changeNoteStatus`);
                const textarea = document.querySelector(`#note-${noteId}-addNoteComment`);
                const fixedEncodeURIComponent = (str) => encodeURIComponent(str).replace(/[!'()*]/g, (c) => '%' + codePointAt(c, 0).toString(16));
                let params;
                if (select.value) {
                  switch (select.value) {
                    case 'closed':
            ...
            postCommentAndMemoState(target, noteId).then(updateNoteCommentsList).then((modifiedNoteData) => {
        ...
        const findNotes = (condition) => {
          ...
          db.notes.reverse().sortBy('created').then((notes) => {
            const noteIds = [];
            notes.forEach((note) => {
            ...
            return Promise.all(noteIds.map((noteId) => {
              return db.comments.where('noteId').equals(noteId).toArray().then((comments) => {
            ...
            const foundNotesEvent = new CustomEvent('foundNotesAndNoteComments', {
              detail: foundNotes,
            });
            const reactRootWrapperElement = document.querySelector('#AppWrapper');
        ...
        const createNoteData = (noteElement, lastModified, noteId) => {
          const latlng = {
        ...
        const createNoteCommentData = (commentElement, commentNum, noteId) => {
